...
,p_default_workspace_id=>12817544392393566474
,p_default_application_id=>93984
,p_default_owner=>'JACKSCHEMA'
);
end;
/
prompt --application/set_environment
 
prompt APPLICATION 93984 - Rest Test Mobile
--
-- Application Export:
--   Application:     93984
--   Name:            Rest Test Mobile
--   Date and Time:   15:39 Tuesday November 24, 2015
--   Exported By:     J_J_JIANG@YAHOO.COM
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,93984)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'JACKSCHEMA')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Rest Test Mobile')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_93984')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'92B4299ADF444BBA9152EEE992C827F6CBEB1D38E4A6A78ACB636177D9715F7F'
...
,p_authentication_id=>wwv_flow_api.id(15481740471711328646)
...
,p_csv_encoding=>'Y'
,p_last_updated_by=>'J_J_JIANG@YAHOO.COM'
,p_last_upd_yyyymmddhh24miss=>'20151124104825'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(15481731677741328638)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15481741394817328647)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15482526996790727243)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15481731324451328638)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15481731459233328638)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15481731554525328638)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(15481740331664328645)
,p_icon_sequence=>200
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18135664851792576771)
,p_lov_name=>'GET_PRIESTS'
...
' ',
' json_table(t.clob001, ''$.WNAME[*]'' COLUMNS rid for ordinality, wname varchar2(30) path ''$'') jt1',
',',
'json_table(t.clob001, ''$.WNO[*]'' COLUMNS rid for ordinality, wno number path ''$'') jt2',
'where t.collection_name = ''P2_DOREST_RESULTS'' and ',
'jt1.rid = jt2.rid'))
);
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18393499554321199642)
,p_lov_name=>'NAMES'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select ',
'jt2.wno r, ',
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(15481740548791328646)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15481731737533328638)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15481731883679328639)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15481731912628328639)
,p_page_template_id=>wwv_flow_api.id(15481731883679328639)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15481732039895328639)
,p_page_template_id=>wwv_flow_api.id(15481731883679328639)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15481732125014328639)
,p_page_template_id=>wwv_flow_api.id(15481731883679328639)
,p_name=>'Header Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15481732698493328639)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15481735090506328641)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15481739213389328644)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481732774850328639)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481732830512328639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481732955811328639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733064880328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733133971328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733240021328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733349012328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733414250328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733579210328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733641072328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733748733328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733894518328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481733952046328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15481734014239328640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15481734213705328641)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15481734300694328641)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15481734467418328641)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15481734574225328641)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15481734618317328641)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15481734197083328640)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15481734721820328641)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15481734810664328641)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15481734928510328641)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(15481739635041328644)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15481739521007328644)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(15481740118993328645)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(15481731883679328639)
,p_default_dialog_template=>wwv_flow_api.id(15481731737533328638)
,p_error_template=>wwv_flow_api.id(15481731883679328639)
,p_printer_friendly_template=>wwv_flow_api.id(15481731883679328639)
,p_login_template=>wwv_flow_api.id(15481731883679328639)
,p_default_button_template=>wwv_flow_api.id(15481739213389328644)
,p_default_region_template=>wwv_flow_api.id(15481733894518328640)
,p_default_chart_template=>wwv_flow_api.id(15481733894518328640)
,p_default_form_template=>wwv_flow_api.id(15481733894518328640)
,p_default_reportr_template=>wwv_flow_api.id(15481734014239328640)
,p_default_tabform_template=>wwv_flow_api.id(15481733894518328640)
,p_default_wizard_template=>wwv_flow_api.id(15481733894518328640)
,p_default_irr_template=>wwv_flow_api.id(15481733894518328640)
,p_default_report_template=>wwv_flow_api.id(15481734197083328640)
,p_default_label_template=>wwv_flow_api.id(15481734810664328641)
,p_default_calendar_template=>wwv_flow_api.id(15481739521007328644)
,p_default_list_template=>wwv_flow_api.id(15481734467418328641)
,p_default_nav_list_template=>wwv_flow_api.id(15481734300694328641)
,p_default_top_nav_list_temp=>wwv_flow_api.id(15481734300694328641)
,p_default_side_nav_list_temp=>wwv_flow_api.id(15481734618317328641)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(15481732774850328639)
,p_default_dialogr_template=>wwv_flow_api.id(15481733894518328640)
,p_default_option_label=>wwv_flow_api.id(15481734810664328641)
,p_default_header_template=>wwv_flow_api.id(15481733579210328640)
,p_default_footer_template=>wwv_flow_api.id(15481733349012328640)
,p_default_required_label=>wwv_flow_api.id(15481734928510328641)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15481739793943328644)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15481739865595328644)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15481739955723328644)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15481740054436328644)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15481732246515328639)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15481735127303328641)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15481735976901328642)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481732392023328639)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(15481732246515328639)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481732409820328639)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481732547913328639)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735241062328641)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
,p_display_name=>'Bottom'
,p_display_sequence=>50
,p_button_template_id=>wwv_flow_api.id(15481735090506328641)
,p_css_classes=>'ui-btn-icon-bottom'
,p_group_id=>wwv_flow_api.id(15481735127303328641)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735365168328642)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735450716328642)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735525047328642)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735634296328642)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735789108328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481735865303328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736015389328642)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
...
,p_group_id=>wwv_flow_api.id(15481735976901328642)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736199740328642)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736276523328642)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736302920328642)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736407213328642)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736500855328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736668354328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736783388328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736826131328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481736940106328642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737054803328642)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737150152328643)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737285000328643)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737308769328643)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737438476328643)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737523362328643)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737668306328643)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737772030328643)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737837385328643)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481737940683328643)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738004120328643)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738193710328643)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738283667328643)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738344281328643)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738485683328643)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738581851328643)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738695019328643)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738724863328644)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738824742328644)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481738999297328644)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481739063946328644)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481739157522328644)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481739325714328644)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(15481739213389328644)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15481739449741328644)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(15481740471711328646)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(15481740267141328645)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(15481731677741328638)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(15481734618317328641)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(15481740267141328645)
...
,p_last_upd_yyyymmddhh24miss=>'20151025004613'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15481740858838328646)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15481733579210328640)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15481741100952328646)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15481733349012328640)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15481741010505328646)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(15481740858838328646)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15481740953381328646)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15481741245455328646)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(15481740953381328646)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15481741245455328646)
,p_event_id=>wwv_flow_api.id(15481741245455328646)
,p_event_result=>'TRUE'
...
,p_last_updated_by=>'J_J_JIANG@YAHOO.COM'
,p_last_upd_yyyymmddhh24miss=>'20151123081417'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18134925808928526201)
,p_plug_name=>'Choose a god'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15481733894518328640)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(15481731677741328638)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(15481734467418328641)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15481811853931374902)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15481733894518328640)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15481820173788374915)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(15481734014239328640)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
'--select clob001 from apex_collec1ons ',
'--where collection_name = ''P2_DOREST_RESULTS'' ',
'select ',
'jt1.wno wno , ',
'jt2.wname wname, ',
'jt3.job job, ',
'jt4.sal sal from apex_collections t, ',
'json_table(t.clob001, ''$.WNO[*]'' COLUMNS rid for ordinality, wno number path ''$'') jt1',
',',
' json_table(t.clob001, ''$.WNAME[*]'' COLUMNS rid for ordinality, wname varchar2(30) path ''$'') jt2',
', ',
...
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(15481734197083328640)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18134926658883526209)
,p_query_column_id=>1
,p_column_alias=>'WNO'
,p_column_display_sequence=>4
,p_column_heading=>'Wno'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(17579137754309266602)
,p_query_column_id=>2
,p_column_alias=>'WNAME'
,p_column_display_sequence=>3
,p_column_heading=>'Wname'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15205968554972326904)
,p_query_column_id=>3
,p_column_alias=>'JOB'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15205968600771326905)
,p_query_column_id=>4
,p_column_alias=>'SAL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15481812243269374903)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15481811853931374902)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15481812638073374903)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481813427485374906)
,p_name=>'P2_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
,p_item_default=>'jdbc:oracle:thin:@sayonara.microlab.cs.utexas.edu:1521:orcl'
,p_prompt=>'Db'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(15481734810664328641)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481814283163374909)
,p_name=>'P2_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
,p_item_default=>'C##cs347_jj32478'
,p_prompt=>'User'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481815006708374910)
,p_name=>'P2_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
,p_item_default=>'orcl_jj32478'
,p_prompt=>'Pass'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481815866815374911)
,p_name=>'P2_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481816637825374912)
,p_name=>'P2_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
,p_item_default=>'C4'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481817401801374912)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481818236381374913)
,p_name=>'P2_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15481819038951374914)
,p_name=>'P2_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(15481811853931374902)
,p_item_default=>'"MATCH (a:worshiper) RETURN a"'
,p_prompt=>'Query'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15481813043701374904)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'15481744853913336722:15481745099152336724'
,p_attribute_01=>wwv_flow_api.id(15481745099152336724)
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(15481744853913336722)
,p_name=>'RestfulReL'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(15481745099152336724)
,p_ws_id=>wwv_flow_api.id(15481744853913336722)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481745345846336726)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481819424543374914)
,p_parameter_id=>wwv_flow_api.id(15481745345846336726)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481745637851336727)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481747109239343105)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481813855187374908)
,p_parameter_id=>wwv_flow_api.id(15481747109239343105)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_DB'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481747440141343105)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481814610153374909)
,p_parameter_id=>wwv_flow_api.id(15481747440141343105)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_USER'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481747701549343105)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481815488557374910)
,p_parameter_id=>wwv_flow_api.id(15481747701549343105)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_PASS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481748029177343106)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481816214517374911)
,p_parameter_id=>wwv_flow_api.id(15481748029177343106)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODE'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481748388053343106)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481817078365374912)
,p_parameter_id=>wwv_flow_api.id(15481748388053343106)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODEL'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481748667163343106)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481817816816374913)
,p_parameter_id=>wwv_flow_api.id(15481748667163343106)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15481748973440343106)
,p_ws_opers_id=>wwv_flow_api.id(15481745099152336724)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15481818680279374914)
,p_parameter_id=>wwv_flow_api.id(15481748973440343106)
,p_process_id=>wwv_flow_api.id(15481813043701374904)
,p_map_type=>'ITEM'
